...
const TEST_CASES = [
    ...
    },
    {
        ...
        tool: ellen_tools_1.ELLEN_TOOLS.FLASHCARD_GENERATOR,
    ...
    },
    {
        ...
        tool: ellen_tools_1.ELLEN_TOOLS.CONCEPT_MAPPER,
    ...
    },
    {
        ...
        tool: ellen_tools_1.ELLEN_TOOLS.CLASS_TROUBLESHOOTER,
...
async function runTest(testCase) {
    ...
    try {
        ...
        const modelRouting = await (0, model_router_1.routeToModel)({
            complexity: 'medium',
            toolName: testCase.tool
        });
        // Execute the tool
        const result = await ellen_tools_1.ellenTools.execute(testCase.message, testCase.tool, {
...
async function runAllTests() {
    ...
    for (const message of autoTests) {
        ...
        try {
            ...
            const result = await ellen_tools_1.ellenTools.execute(message, undefined, // Let it auto-select
            { userMessage: message, modelRouting }, modelRouting);
