...
class ContentIndexer {
    ...
    constructor() {
        ...
        this.voyage = new voyageai_1.VoyageAIClient({
            apiKey: process.env.VOYAGE_API_KEY,
        });
    }
    async indexContentSeeds(seedPath, namespace = 'public') {
    ...
    async createVectorsFromCard(card) {
        const vectors = [];
    ...
    async createIndex(indexName, dimension = 1024) {
        try {
