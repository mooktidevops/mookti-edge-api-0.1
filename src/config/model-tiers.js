...
exports.FRONTIER_MODELS = exports.MODEL_TIERS = void 0;
exports.getTierConfig = getTierConfig;
exports.getModelForTier = getModelForTier;
exports.getTierByComplexity = getTierByComplexity;
exports.shouldEscalateTier = shouldEscalateTier;
exports.MODEL_TIERS = {
    1: {
        tier: 1,
        name: 'Simple/Fast',
...
function getTierConfig(tier) {
    return exports.MODEL_TIERS[tier];
}
function getModelForTier(tier, useFallback = false) {
    const config = exports.MODEL_TIERS[tier];
    return useFallback ? config.fallback : config.primary;
}
function getTierByComplexity(complexity) {
    const mapping = {
        'simple': 1,
        'balanced': 2,
        'complex': 3,
...
function shouldEscalateTier(currentTier, errorRate) {
