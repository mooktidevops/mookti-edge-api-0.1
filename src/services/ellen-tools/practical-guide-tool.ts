...
export interface PracticalGuideParams {
  message: string;
 ...
 */
export class PracticalGuideTool {
  name = 'practical_guide';
  description = 'Provides step-by-step practical guidance for academic tasks';
  
  async execute(params: PracticalGuideParams): Promise<PracticalGuideResult> {
...
export const practicalGuideTool = new PracticalGuideTool();