...
exports.StudyUtilitiesOrchestrator = exports.AnalogyBuilderTool = exports.WorkedExampleWalkerTool = exports.ConceptMapperTool = exports.FlashcardGeneratorTool = void 0;
...
Create 5-10 high-quality flashcards with spaced repetition metadata.`;
    ...
    parseFlashcardResponse(text, context) {
...
exports.FlashcardGeneratorTool = FlashcardGeneratorTool;
/**
 * Concept Mapper Tool
...
\`\`\``,
    ...
    parseConceptMapResponse(text, context) {
...
exports.ConceptMapperTool = ConceptMapperTool;
/**
 * Worked Example Walker
 * Research: Sweller & Cooper (1985) - Worked example effect
 */
class WorkedExampleWalkerTool {
    async execute(context) {
...
Show complete step-by-step solution with explanations.`,
    ...
    parseWorkedExampleResponse(text, context) {
        const steps = [
            {
                stepNumber: 1,
...
exports.WorkedExampleWalkerTool = WorkedExampleWalkerTool;
/**
 * Analogy Builder Tool
 * Research: Gentner & Holyoak (1997) - Structural mapping in analogy
 */
class AnalogyBuilderTool {
    async execute(context) {
...
Develop structural mapping with clear correspondences.`,
    ...
    parseAnalogyResponse(text, context) {
        const mapping = {
...
exports.AnalogyBuilderTool = AnalogyBuilderTool;
/**
 * Study Utilities Orchestrator
 */
class StudyUtilitiesOrchestrator {
    flashcardGenerator = new FlashcardGeneratorTool();
    conceptMapper = new ConceptMapperTool();
    workedExampleWalker = new WorkedExampleWalkerTool();
    analogyBuilder = new AnalogyBuilderTool();
    async selectAndExecute(context, utilityName) {
        if (utilityName) {
    ...
    async executeUtility(name, context) {
        switch (name) {
            case 'flashcard':
...
exports.StudyUtilitiesOrchestrator = StudyUtilitiesOrchestrator;
