...
exports.UserStateMonitor = void 0;
...
class UserStateMonitor {
    ...
    async analyzeState(message, conversationHistory, currentTool) {
        // Quick check for obvious state changes first
        const quickCheck = this.quickStateCheck(message);
        if (quickCheck && quickCheck.sentiment?.frustrationLevel && quickCheck.sentiment.frustrationLevel >= 8) {
...
exports.UserStateMonitor = UserStateMonitor;
